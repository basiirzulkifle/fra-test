    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_ver', models.CharField(blank=True, max_length=100, null=True)),
                ('is_default', models.BooleanField(default=False)),
                ('device_username', models.CharField(default='', max_length=50)),
                ('device_password', models.CharField(default='', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('building', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.building')),
                ('floor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.floor')),
            ],
        ),
        migrations.CreateModel(
            name='Tenant',
